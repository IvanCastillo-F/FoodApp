...
class GetFoodByName@Inject constructor(private val cocktailRepository: FoodRepository) :
    UseCase<FoodResponse, String>() {

    override suspend fun run(params: String) = cocktailRepository.getFoodByName(params)
